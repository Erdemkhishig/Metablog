...
export const Navbar = () => {
    ...
    return (
        ...
        <div id="up" className="px-4">
            ...
            <div className={checked ? 'duration-500  translate-x-0 right-0 fixed top-0 w-9/12 h-max bg-white flex flex-col' : "translate-x-[100%] duration-500 right-0 fixed top-0 w-9/12 h-max  bg-white flex flex-col"}><Sidebar check={checked} setChecked={handleSidebar} /></div>
